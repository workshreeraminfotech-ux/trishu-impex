...
import { Search, ArrowRight, Eye, Sparkles, Filter, CheckCircle2, Grid3X3 } from 'lucide-react';
import { TILES_CATEGORIES } from '../data/tilesProducts';
import { getTilesProducts } from '../utils/adminStore';
    ...
    <div style={{ backgroundColor: '#F8FAFC', minHeight: '100vh', paddingBottom: '100px' }}>
      ...
      <section style={{
        ...
        <img 
          ...
          alt="Tiles Catalogue Background" 
          style={{
            position: 'absolute',
            inset: 0,
            width: '100%',
        ...
        <div style={{
          position: 'absolute',
          inset: 0,
          background: 'linear-gradient(180deg, rgba(30, 27, 24, 0.85) 0%, rgba(15, 23, 42, 0.92) 100%)',
          zIndex: 1
        }} />
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          ...
          >
            <span style={{
              ...
              <Grid3X3 size={14} style={{ color: '#ED6C1B' }} />
              World-Class Indian Ceramic & Vitrified Hub • {productsList.length} Tile Formats
            </span>
            ...
            <h1 style={{
              ...
              <span style={{ color: '#ED6C1B' }}>Tiles & Ceramics Catalogue</span>
            </h1>
            ...
            <p style={{
              ...
              Polished Glazed Vitrified Tiles (PGVT/GVT 60x120cm, 80x160cm), Ceramic Wall Tiles, Heavy-Duty Outdoor Parking Tiles & Porcelain Surfaces for international exports.
            </p>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', background: 'rgba(255, 255, 255, 0.1)', padding: '8px 18px', borderRadius: '100px', border: '1px solid rgba(237, 108, 27, 0.4)' }}>
                <CheckCircle2 size={16} style={{ color: '#ED6C1B' }} />
                <span>Zero Porosity & Stain Proof</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', background: 'rgba(255, 255, 255, 0.1)', padding: '8px 18px', borderRadius: '100px', border: '1px solid rgba(237, 108, 27, 0.4)' }}>
                <CheckCircle2 size={16} style={{ color: '#ED6C1B' }} />
                <span>Fumigated Euro Pallet Shipping</span>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      <div className="container" style={{ marginTop: '-40px', position: 'relative', zIndex: 10 }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <input
                type="text"
                placeholder="Search tiles by finish or size (e.g. 600x1200, PGVT, Marble, Parking, Wall Tiles...)"
                value={searchTerm}
        ...
        <div style={{
          ...
          <p style={{ fontSize: '14.5px', color: 'var(--gray)', fontWeight: 600 }}>
            Showing <strong style={{ color: 'var(--navy)' }}>{filteredProducts.length}</strong> of <strong style={{ color: 'var(--navy)' }}>{productsList.length}</strong> tile collections
        ...
        {filteredProducts.length === 0 && (
          <div style={{
            ...
            >
              View All {productsList.length} Tiles Collections
            </button>
          </div>
        )}
      </div>
