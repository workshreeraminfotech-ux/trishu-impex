...
import { Search, ArrowRight, Eye, Sparkles, Filter, CheckCircle2, Bath } from 'lucide-react';
import { getSanitarywareProducts, getCategories } from '../utils/adminStore';
    ...
    <div style={{ backgroundColor: '#F8FAFC', minHeight: '100vh', paddingBottom: '100px' }}>
      ...
      <section style={{
        ...
        <img 
          ...
          alt="Sanitaryware Catalogue Background" 
          style={{
            position: 'absolute',
            inset: 0,
            width: '100%',
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          ...
          >
            <span style={{
              ...
              <Bath size={14} style={{ color: '#ED6C1B' }} />
              Export Grade Ceramic & Vitreous China • {productsList.length} Products
            </span>
            ...
            <h1 style={{
              ...
              <span style={{ color: '#ED6C1B' }}>Sanitaryware Catalogue</span>
            </h1>
            ...
            <p style={{
              ...
              Vitreous China One-Piece Toilets, Wall-Hung Closets, Tabletop Wash Basins, Urinals & Ceramic Vanity Tops engineered for international architectural tenders.
            </p>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', background: 'rgba(255, 255, 255, 0.1)', padding: '8px 18px', borderRadius: '100px', border: '1px solid rgba(237, 108, 27, 0.4)' }}>
                <CheckCircle2 size={16} style={{ color: '#ED6C1B' }} />
                <span>Water Absorption &lt; 0.5%</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', background: 'rgba(255, 255, 255, 0.1)', padding: '8px 18px', borderRadius: '100px', border: '1px solid rgba(237, 108, 27, 0.4)' }}>
                <CheckCircle2 size={16} style={{ color: '#ED6C1B' }} />
                <span>Palletized Export Container Shipping</span>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      <div className="container" style={{ marginTop: '-40px', position: 'relative', zIndex: 10 }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <input
                type="text"
                placeholder="Search sanitaryware (e.g. One-Piece Toilet, Wall Hung, Tabletop Basin, Urinal, Vanity...)"
                value={searchTerm}
        ...
        <div style={{
          ...
          <p style={{ fontSize: '14.5px', color: 'var(--gray)', fontWeight: 600 }}>
            Showing <strong style={{ color: 'var(--navy)' }}>{filteredProducts.length}</strong> of <strong style={{ color: 'var(--navy)' }}>{productsList.length}</strong> sanitaryware items
        ...
        {filteredProducts.length === 0 && (
          <div style={{
            ...
            <h3 style={{ fontSize: '20px', fontWeight: 800, color: 'var(--navy)', marginBottom: '8px' }}>
              No sanitaryware products match "{searchTerm}"
            </h3>
            ...
            >
              View All {productsList.length} Sanitaryware Products
            </button>
          </div>
        )}
      </div>
