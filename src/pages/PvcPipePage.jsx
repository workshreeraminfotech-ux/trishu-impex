...
import { Search, ArrowRight, Eye, Sparkles, Filter, CheckCircle2, Waves } from 'lucide-react';
import { PVC_PIPE_CATEGORIES } from '../data/pvcPipeProducts';
import { getPvcPipeProducts } from '../utils/adminStore';
    ...
    <div style={{ backgroundColor: '#F8FAFC', minHeight: '100vh', paddingBottom: '100px' }}>
      ...
      <section style={{
        ...
        <img 
          ...
          alt="PVC Pipes Catalogue Background" 
          style={{
            position: 'absolute',
            inset: 0,
            width: '100%',
        ...
        <div style={{
          position: 'absolute',
          inset: 0,
          background: 'linear-gradient(180deg, rgba(12, 74, 110, 0.85) 0%, rgba(15, 23, 42, 0.94) 100%)',
          zIndex: 1
        }} />
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          ...
          >
            <span style={{
              ...
              <Waves size={14} style={{ color: '#ED6C1B' }} />
              ASTM & IS Certified Lead-Free Piping • {productsList.length} Pipe Systems
            </span>
            ...
            <h1 style={{
              ...
              <span style={{ color: '#ED6C1B' }}>PVC & CPVC Pipes Catalogue</span>
            </h1>
            ...
            <p style={{
              ...
              UPVC Pressure Plumbing Pipes (Sch 40/80), CPVC Hot & Cold Water Pipes, SWR Drainage Systems, Rigid Agri Pipes & Conduit Ducts packed for container shipping.
            </p>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', background: 'rgba(255, 255, 255, 0.1)', padding: '8px 18px', borderRadius: '100px', border: '1px solid rgba(237, 108, 27, 0.4)' }}>
                ...
                <span>ASTM D1785 & IS 15778 Standards</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', background: 'rgba(255, 255, 255, 0.1)', padding: '8px 18px', borderRadius: '100px', border: '1px solid rgba(237, 108, 27, 0.4)' }}>
                <CheckCircle2 size={16} style={{ color: '#ED6C1B' }} />
                <span>100% Lead-Free & Potable Certified</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', background: 'rgba(255, 255, 255, 0.1)', padding: '8px 18px', borderRadius: '100px', border: '1px solid rgba(237, 108, 27, 0.4)' }}>
                <CheckCircle2 size={16} style={{ color: '#ED6C1B' }} />
                <span>Optimized Container Nested Bundles</span>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      <div className="container" style={{ marginTop: '-40px', position: 'relative', zIndex: 10 }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <input
                type="text"
                placeholder="Search pipes by type (e.g. UPVC Sch 40, CPVC Hot Water, SWR Drainage, Conduit, Fittings...)"
                value={searchTerm}
        ...
        <div style={{
          ...
          <p style={{ fontSize: '14.5px', color: 'var(--gray)', fontWeight: 600 }}>
            Showing <strong style={{ color: 'var(--navy)' }}>{filteredProducts.length}</strong> of <strong style={{ color: 'var(--navy)' }}>{productsList.length}</strong> piping systems
        ...
        {filteredProducts.length === 0 && (
          <div style={{
            ...
            >
              View All {productsList.length} PVC Pipe Products
            </button>
          </div>
        )}
      </div>
