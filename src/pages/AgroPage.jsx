...
import { Search, ArrowRight, Eye, Sparkles, Filter, CheckCircle2, Sprout } from 'lucide-react';
import { getAgroProducts, getCategories } from '../utils/adminStore';
...
export default function AgroPage({ onSelectProduct, onOpenQuote }) {
  ...
  return (
    <div style={{ backgroundColor: '#F8FAFC', minHeight: '100vh', paddingBottom: '100px' }}>
      ...
      {/* Dynamic Hero Section — Agriculture Themed Overlay */}
      <section style={{
        position: 'relative',
        color: '#FFFFFF',
        padding: '75px 0 65px',
        overflow: 'hidden',
        backgroundColor: '#152518'
      }}>
        {/* Background Image — Lush Golden Wheat / Grain Fields */}
        <img 
          src="https://images.unsplash.com/photo-1500937386664-56d1dfef3854?auto=format&fit=crop&w=1920&q=80" 
          alt="Agro Commodities Background" 
          style={{
            position: 'absolute',
            inset: 0,
            width: '100%',
        ...
        />
        {/* Warm Golden-Green Dark Overlay */}
        <div style={{
          position: 'absolute',
          inset: 0,
          background: 'linear-gradient(180deg, rgba(20, 36, 22, 0.82) 0%, rgba(15, 23, 42, 0.90) 100%)',
          zIndex: 1
        }} />
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          ...
          >
            <span style={{
              ...
              <Sprout size={14} style={{ color: '#ED6C1B' }} />
            ...
            <h1 style={{
              ...
              <span style={{ color: '#ED6C1B' }}>Agro Commodities Catalogue</span>
            </h1>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', background: 'rgba(255, 255, 255, 0.1)', padding: '8px 18px', borderRadius: '100px', border: '1px solid rgba(237, 108, 27, 0.4)' }}>
                ...
                <span>APEDA & AGMARK Certified</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', background: 'rgba(255, 255, 255, 0.1)', padding: '8px 18px', borderRadius: '100px', border: '1px solid rgba(237, 108, 27, 0.4)' }}>
                <CheckCircle2 size={16} style={{ color: '#ED6C1B' }} />
                <span>100% Sortex Cleaned & Non-GMO</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', background: 'rgba(255, 255, 255, 0.1)', padding: '8px 18px', borderRadius: '100px', border: '1px solid rgba(237, 108, 27, 0.4)' }}>
                <CheckCircle2 size={16} style={{ color: '#ED6C1B' }} />
                <span>Bulk Container & Vessel Freight</span>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      <div className="container" style={{ marginTop: '-40px', position: 'relative', zIndex: 10 }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <input
                type="text"
                placeholder="Search agro products (e.g. Basmati Rice, Wheat, Yellow Corn, Barley, Chickpeas, Sesame...)"
                value={searchTerm}
        ...
        <div style={{
          ...
          <p style={{ fontSize: '14.5px', color: 'var(--gray)', fontWeight: 600 }}>
            Showing <strong style={{ color: 'var(--navy)' }}>{filteredProducts.length}</strong> of <strong style={{ color: 'var(--navy)' }}>{productsList.length}</strong> commodities
        ...
        >
          <AnimatePresence>
            {filteredProducts.map((product, idx) => (
              ...
              >
                {/* Product Image — Object-Fit Cover with elegant card framing */}
                <div style={{
                  position: 'relative',
                  height: '230px',
        ...
        {filteredProducts.length === 0 && (
          <div style={{
            ...
            <h3 style={{ fontSize: '20px', fontWeight: 800, color: 'var(--navy)', marginBottom: '8px' }}>
              No agro commodities match "{searchTerm}"
            </h3>
            ...
            >
              View All {productsList.length} Agro Products
            </button>
          </div>
        )}
      </div>
